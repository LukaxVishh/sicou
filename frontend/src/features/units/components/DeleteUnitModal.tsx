  ...
  async function handleDelete() {
    ...
    try {
      ...
      const message = error instanceof Error
        ? error.message
        : 'Não foi possível inativar a unidade.';
      ...
      <div className="w-full max-w-md rounded-2xl bg-white shadow-xl ring-1 ring-slate-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Confirme a inativação desta unidade.
              </p>
            </div>
          </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-sm text-slate-600">
            Você está prestes a inativar a unidade:
          </p>
          ...
          <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
            ...
            <p className="mt-1 text-xs text-slate-500">
              {unit.code || 'Código não informado'}
            </p>
          </div>

          <p className="mt-4 text-sm text-slate-600">
            A unidade continuará registrada no sistema, mas ficará marcada como
            inativa.
          </p>
          ...
          <div className="mt-6 flex justify-end gap-3 border-t border-slate-200 pt-5">
            ...
            >
              {isSubmitting ? 'Inativando...' : 'Inativar unidade'}
            </button>
          </div>
        </div>
      </div>
