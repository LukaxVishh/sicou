...
namespace Sicou.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260607155343_AddUserAreaAccesses")]
    partial class AddUserAreaAccesses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sicou.Domain.Entities.AreaModule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("area_modules", (string)null);
                });

            modelBuilder.Entity("Sicou.Domain.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sicou.Domain.Entities.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sicou.Domain.Entities.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sicou.Domain.Entities.AreaModule", b =>
                {
                    b.HasOne("Sicou.Domain.Entities.Area", "Area")
                        .WithMany("AreaModules")
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sicou.Domain.Entities.Module", "Module")
                        .WithMany("AreaModules")
